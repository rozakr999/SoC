proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI ] [get_bd_intf_pins i2c_0/AXI_Interface]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/ACLK] [get_bd_pins i2c_0/AXI_Interface_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/ARESETN] [get_bd_pins i2c_0/AXI_Interface_ARESETN]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/i2c_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef i2c_tb_include_vh_"
	puts $fp "`define i2c_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/i2c_tb.sv
...
remove_files -quiet -fileset sim_1 i2c_tb_include.vh
