...
proc create_ipi_design { offsetfile design_name } {
	...
	set i2c_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:i2c:1.0 i2c_0 ]
	...
	# Connect all clock & reset of i2c_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins i2c_0/AXI_Interface]
	connect_bd_net [get_bd_pins i2c_0/axi_interface_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins i2c_0/axi_interface_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to i2c_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/i2c_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_i2c_0_AXI_Interface_* ]]
	puts $fp "set axi_interface_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:i2c:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/i2c_hw_test.tcl
