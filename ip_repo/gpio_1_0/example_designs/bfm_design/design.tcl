...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/gpio_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef gpio_tb_include_vh_"
	puts $fp "`define gpio_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/gpio_tb.sv
...
remove_files -quiet -fileset sim_1 gpio_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top gpio_tb [get_filesets sim_1]
