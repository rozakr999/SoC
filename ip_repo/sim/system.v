...
module system
  ...
  system_gpio_0_2 gpio_0
       (.axi_aclk(processing_system7_0_FCLK_CLK0),
        .axi_araddr(axi_smc_M00_AXI_ARADDR),
        .axi_aresetn(proc_sys_reset_0_peripheral_aresetn),
        .axi_arprot(axi_smc_M00_AXI_ARPROT),
        .axi_arready(axi_smc_M00_AXI_ARREADY),
        .axi_arvalid(axi_smc_M00_AXI_ARVALID),
        .axi_awaddr(axi_smc_M00_AXI_AWADDR),
        .axi_awprot(axi_smc_M00_AXI_AWPROT),
        .axi_awready(axi_smc_M00_AXI_AWREADY),
        .axi_awvalid(axi_smc_M00_AXI_AWVALID),
        .axi_bready(axi_smc_M00_AXI_BREADY),
        .axi_bresp(axi_smc_M00_AXI_BRESP),
        .axi_bvalid(axi_smc_M00_AXI_BVALID),
        .axi_rdata(axi_smc_M00_AXI_RDATA),
        .axi_rready(axi_smc_M00_AXI_RREADY),
        .axi_rresp(axi_smc_M00_AXI_RRESP),
        .axi_rvalid(axi_smc_M00_AXI_RVALID),
        .axi_wdata(axi_smc_M00_AXI_WDATA),
        .axi_wready(axi_smc_M00_AXI_WREADY),
        .axi_wstrb(axi_smc_M00_AXI_WSTRB),
        .axi_wvalid(axi_smc_M00_AXI_WVALID),
